...
import ProductsPageContiner from "@/components/ProductsContainer"
...
//                     <td className="py-3">
//                       <span
//                         className={`px-2 py-0.5 rounded-full text-[10px] font-medium ${product.stock > 0
